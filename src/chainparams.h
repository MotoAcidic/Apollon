 ...
 * APOLLON system. There are three: the main network on which people trade goods
...
public:
    ...
    int ApollonBadBlockTime() const { return nApollonBadBlockTime; }
    int ApollonBadBlocknBits() const { return nApollonBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nApollonBadBlockTime;
    unsigned int nApollonBadBlocknBits;
