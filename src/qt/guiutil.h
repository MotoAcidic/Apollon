...
/** Utility functions used by the APOLLON Qt UI.
 */
namespace GUIUtil
{
...
// Render APOLLON addresses in monospace font
...
// Parse "apollon:" URI into recipient object, return true on successful parsing
